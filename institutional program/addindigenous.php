...
if (isset($_POST['addIndigenous'])) {
    $indigenousgroup = test_input($_POST['indigenousgroup']);
    $sql = "INSERT INTO tblindigenous VALUES (null, '$indigenousgroup',  '$noano')";
    $result = $conn->query($sql);

    //audit add
    date_default_timezone_set('Asia/Manila');
    $user=$_SESSION["username"];
    $action = "Added a record in indigenous.";
    $dateandtime = date("Y-m-d H:i:s");
    $sql = "INSERT INTO tblaudit (action, user, dateandtime) VALUES ('$action', '$user', '$dateandtime')";
    $conn->query($sql) or die(mysqli_error($conn));

    echo "<script>alert('Indigenous student record successfully added!');
        window.location='indigenous.php';
        </script>";
}
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <input required name="indigenousgroup" type="text" id="indi" class="form-control" 
                    ...
                    <div class="text-center">
                        <input name="addIndigenous" type="submit" class="mr-5 btn btn-primary" value="Add">
