            ...
            <div class="card-body">
                <div class="container-fluid">
                    <table id="myTable" class="table display table-responsive table-bordered table-striped">
                        ...
                        <a href='editforeignstudent.php?studnum=$row[studnum]'><span class=\"fas fa-edit\"></span></a>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="delete" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="deleteforeignstudent.php" method="post">
            ...
            buttons: [
                {
                    ...
                    text: '<span class="fas fa-plus-circle"></span>&nbsp;Add Foreign Student',
                    action: function (e, dt, node, config) {
                        window.location = 'noalist4.php';
                    }
                },
                {
                    ...
                    action: function (e, dt, node, config) {
                        window.location = 'printforeign.php';
                    },
                }
            ],
        });

        $('#myTable tbody').on('click', '#editForeignStudent', function () {
            var tr = $(this).parents('tr').closest('tr');
            row = table.row(tr).data();
            window.location = 'editForeignStudent.php?studnum=' + row[0];
        });
