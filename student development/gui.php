...
<head lang="en">
    ...
    <title>Student Development and Services | Dashboard</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="dashboard.php">
        ...
        Student Development and Services | <?php echo $_SESSION["x"] ?>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="accordion" style="overflow: auto">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="studentOrganization">
                <a class="nav-link" href="studentorgs.php">
                    <span class="fas fa-sitemap"></span>
                    <span class="nav-link-text">Student Organization</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Permit">
                <a class="nav-link" href="permit.php">
                    <span class="fas fa-sticky-note"></span>
                    <span class="nav-link-text">&nbsp;Permit</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Waiver">
                <a class="nav-link" href="waiver.php">
                    <span class="fas fa-file"></span>
                    <span class="nav-link-text">&nbsp;Waiver</span>
                </a>
            </li>
             <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Waiver">
                <a class="nav-link" href="accomplishedactivity.php">
                    <span class="fas fa-file"></span>
                    <span class="nav-link-text">&nbsp;Accomplished Activity</span>
                </a>
            </li>
