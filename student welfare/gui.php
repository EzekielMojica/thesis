...
<head lang="en">
    ...
    <title>Student Welfare | Dashboard</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="dashboard.php">
        ...
        Student Welfare and Services | <?php echo $_SESSION["x"] ?>
    </a>
        ...
        <ul class="navbar-nav navbar-sidenav" id="accordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Students">
                <a class="nav-link" href="students.php">
                    ...
                    <span class="nav-link-text">Student Directory</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Students">
                <a class="nav-link" href="studentasst.php">
                    <span class="fas fa-users"></span>
