...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="dashboard.php">
        ...
        Guidance and Student Discipline | <?php echo $_SESSION["x"] ?>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="accordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Students">
                <a class="nav-link" href="studentoffence.php">
                    <span class="fas fa-ban"></span>
                    <span class="nav-link-text">Student Offense</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Students">
                <a class="nav-link" href="acceptanceslip.php">
                    <span class="fas fa-file"></span>
                    <span class="nav-link-text">Acceptance Slip</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Accomplishment Report">
                <a class="nav-link" href="casereport.php">
                    <span class="fas fa-briefcase"></span>
                    <span class="nav-link-text">Case Reports</span>
                </a>
            </li>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Accomplishment Report">
                <a class="nav-link" href="goodmoral.php">
                    <span class="fas fa-file-alt"></span>
                    <span class="nav-link-text">Good Moral</span>
                </a>
            </li>
